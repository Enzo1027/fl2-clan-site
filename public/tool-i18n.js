(function initializeToolI18n() {
  ...
  const FRAGMENT_SOURCES = [
    ...
    "wrenches", "fragments", "resources", "published", "unpublished", "remaining", "completed", "Ava points",
    ...
    "Evidence", "Download", "Restore", "Search", "Close", "Delete", "Apply", "Ready", "Achieved", "Daily planning", "Add selection",
